...
def setup_DA_params(threeD, do_dummy_2D_aug, patch_size, use_mask_for_norm):
        ...
        if threeD:
            ...
            data_aug_params['rotation_x'] = (0,0) #(-30. / 360 * 2. * np.pi, 30. / 360 * 2. * np.pi)
            data_aug_params['rotation_y'] = (0,0) #(-30. / 360 * 2. * np.pi, 30. / 360 * 2. * np.pi)
            data_aug_params['rotation_z'] = (0,0) #(-30. / 360 * 2. * np.pi, 30. / 360 * 2. * np.pi)
            if do_dummy_2D_aug:
        ...
        data_aug_params["scale_range"] = (1.0,1.0) #(0.7, 1.4)
        data_aug_params["do_elastic"] = False
        data_aug_params['selected_seg_channels'] = [0]
        data_aug_params['patch_size_for_spatialtransform'] = patch_size #patch_size_for_spatialtransform

        data_aug_params["num_cached_per_thread"] = 2

        return data_aug_params, patch_size #basic_generator_patch_size
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params
    ...
    print("PARAMS")
    print(params.get("selected_data_channels"),params.get("selected_seg_channels"),params.get("dummy_2D"))
...
def prepare_generators(config_file, deep_supervision_scales = None):
    ...
    print('generators.py,run_generate.py')
    ...
    #_, val_gen = get_moreDA_augmentation(
    #            dl_tr, dl_val,
    #            data_aug_params['patch_size_for_spatialtransform'],
    #            data_aug_params,
    #            deep_supervision_scales=deep_supervision_scales, 
    ...
    #_, tr_gen = get_moreDA_augmentation(
    #            dl_val, dl_tr,
    #            data_aug_params['patch_size_for_spatialtransform'],
    #            data_aug_params,
    #            deep_supervision_scales=deep_supervision_scales,
